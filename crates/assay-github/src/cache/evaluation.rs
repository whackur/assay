...
/// Complete content identity of an equivalent project evaluation.
...
impl EvaluationKey {
    ...
    /// Canonical length-prefixed material used to derive the digest.
...
/// Lookup result from an outer evaluation cache adapter.
...
/// Cache-aware evaluation admission plan without quota side effects.
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
