...
import { getHostedProject } from "@/lib/api/hosted";
import { LiveProjectStatus } from "@/components/LiveCatalog";

export const dynamic = "force-dynamic";

export default async function HostedProjectPage({ params }: {
  ...
  if (result.state === "unavailable") {
    return (
      <section className="section">
        <h1>Project status unavailable</h1>
        <div className="notice" role="status">The hosted API could not be reached. Assay does not convert missing data to a zero.</div>
      </section>
    );
  }
  ...
  return (
    <section className="section">
      ...
      <div className="notice" role="note" style={{ marginTop: "var(--space-lg)" }}>
        This live page reports ingested GitHub metadata and workflow status only.
        It does not indicate publication approval or catalog inclusion.
        The scored report shown on the home page is a labeled sample fixture.
      </div>
